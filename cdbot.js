...
async function onMessage(message) {
  ...
  if (isAdmin) {
    ...
    if (message.text === '/block') return handleBlock(message);
    if (message.text === '/unblock') return handleUnBlock(message);
    if (message.text === '/checkblock') return checkBlock(message);
