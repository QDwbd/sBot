...
7. 点击`Quick Edit`，复制[这个文件](./bot.js)到编辑器中保存
...
6. 在cf的worker绑定kv数据库，先创建一个Namespace Name为`sBot`的kv数据库，在worker的setting -> variable中设置`KV Namespace Bindings`：sBot -> sBot
